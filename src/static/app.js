document.addEventListener("DOMContentLoaded", () => {
  ...
  // Escape user-provided strings before inserting with innerHTML
                ...
                return `
                  <li class="participant-item">
                    ...
                    <button
                      ...
                      aria-label="Unregister ${escapedParticipant} from ${escapeHtml(name)}"
  ...
  // Handle participant unregistration via delete icon button
